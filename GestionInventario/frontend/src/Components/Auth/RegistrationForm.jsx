...
const RegistrationForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://localhost:7193/api/Auth/register', {
                firstName,
                lastName,
                username,
                email,
            ...
            setError(error.response?.data?.message || 'Error al registrar usuario. Por favor, inténtalo de nuevo.');
        }
    };
