...
const ProductList = () => {
    ...
    const openModal = () => {
        setIsModalOpen(true);
        setNewProduct({ name: '', description: '', price: '' }); // Resetear el formulario
    };
                ...
                <table className="min-w-full bg-white shadow-md rounded-lg">
                    <thead className="bg-gray-100">
                        <tr>
                            ...
                            <th className="hidden sm:table-cell px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Descripción</th>
